class EN:
    class StartSC:
        ...
        DscWelcMSG = "Please choose one out of these modes: [1] Characters Learning (BETA); [2] Full Sentences Learning (Coming Soon!); [3] Translator (ALPHA); [4] News? (Coming Soon!);"
    ...
    class SelectorSC:
        ...
        WrongAwsSub = "Try again: [1] Characters Learning (BETA); [2] Full Sentences Learning (Coming Soon!); [3] Translator (ALPHA); [4] News? (Coming Soon!);"
    ...
    class QuizSC:
        ...
        CowSaysOK = " ,~~~~~~~~~~~~~~~~~~~~~~~~~,\n| Mooo! You got it right!   |\n| \"%s\" makes \"%s\" sound!  :D |\n '~~~~~~~~~~~~~~~~~~~~~~~~~'\n        \\   ^__^\n         \\  (oo)\_______\n            (__)\\       )\\/\n                ||----w |\n                ||     ||"
        CowSaysNo = " ,~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~,\n| Oh-no! Well, \"%s\" makes \"%s\" sound.. |\n| Better luck next tine!           :3 |\n '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'\n        \\   ^__^\n         \\  (oo)\_______\n            (__)\\       )\\/\n                ||----w |\n                ||     ||"
    ...
    class TransSC:
        StartMSG = "Welcome to marsLigo translator! Start by typing your full sentence!"
        ErrorMSG = "Oops, there must be an unsupported character somewhere!"
class PL:
    class StartSC:
